 ...
 * including the current promise count so the indicator is correct even if the
 * block-entity sync is not up to date.
 */
public record ProductReturnStationOpenScreenPacket(BlockPos pos, int totalPromised)
